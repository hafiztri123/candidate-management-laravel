    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-candidates">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-candidates">
                                <a href="#endpoints-POSTapi-candidates">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-candidates--id-">
                                <a href="#endpoints-GETapi-candidates--id-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-candidates--id-">
                                <a href="#endpoints-PUTapi-candidates--id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-candidates--id-">
                                <a href="#endpoints-DELETEapi-candidates--id-">Remove the specified resource from storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-search-candidates">
                                <a href="#endpoints-GETapi-search-candidates">GET api/search/candidates</a>
                            </li>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-candidates">Display a listing of the resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-candidates">Store a newly created resource in storage.</h2>
...
<div class="bash-example">
    ...
    \"current_position\": \"mqeopfuudtdsufvyvddqa\",
    \"education\": \"mniihfqcoynlazghdtqtq\",
    \"status\": \"offered\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-candidates"
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="skills"                data-endpoint="POSTapi-candidates"
               value="consequatur"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="experience"                data-endpoint="POSTapi-candidates"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="education"                data-endpoint="POSTapi-candidates"
...
Must be one of:
<ul style="list-style-type: square;"><li><code>new</code></li> <li><code>contacted</code></li> <li><code>interviewing</code></li> <li><code>offered</code></li> <li><code>hired</code></li> <li><code>rejected</code></li></ul>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-candidates--id-">Display the specified resource.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/candidates/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/candidates/consequatur"
);
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-candidates--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the candidate. Example: <code>consequatur</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-PUTapi-candidates--id-">Update the specified resource in storage.</h2>
...
<div class="bash-example">
    ...
    "http://localhost/api/candidates/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"vmqeopfuudtdsufvyvddq\",
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the candidate. Example: <code>17</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-candidates--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="skills"                data-endpoint="PUTapi-candidates--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="experience"                data-endpoint="PUTapi-candidates--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="education"                data-endpoint="PUTapi-candidates--id-"
               value="mniihfqcoynlazghdtqtq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>mniihfqcoynlazghdtqtq</code></p>
...
<ul style="list-style-type: square;"><li><code>new</code></li> <li><code>contacted</code></li> <li><code>interviewing</code></li> <li><code>offered</code></li> <li><code>hired</code></li> <li><code>rejected</code></li></ul>
                    ...
                    <h2 id="endpoints-DELETEapi-candidates--id-">Remove the specified resource from storage.</h2>
...
<p>The ID of the candidate. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-GETapi-search-candidates">GET api/search/candidates</h2>
...
<span id="example-requests-GETapi-search-candidates">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/search/candidates" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/search/candidates"
);
...
<span id="example-responses-GETapi-search-candidates">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-search-candidates" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-search-candidates"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-search-candidates"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-search-candidates" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-search-candidates">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-search-candidates" data-method="GET"
      data-path="api/search/candidates"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-search-candidates', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-search-candidates"
                    onclick="tryItOut('GETapi-search-candidates');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-search-candidates"
                    onclick="cancelTryOut('GETapi-search-candidates');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-search-candidates"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/search/candidates</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-search-candidates"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-search-candidates"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
